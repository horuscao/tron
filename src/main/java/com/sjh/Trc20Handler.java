...
import com.sjh.monitor_block.MonitorSendSpecificWalletThread;
...
public class Trc20Handler {
    static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Trc20Handler.class);
    private TrxHandler trxHandler;

    //主网 tronUrl = "https://api.trongrid.io";
    private static final String tronUrl = "https://api.trongrid.io";

    //测试网
    private static final String tronUrlTest = "https://www.trongrid.io/shasta";
     ...
     * @throws Throwable
     */
    public synchronized String sendTrc20(String toAddress, BigDecimal amount, String privateKey, String filepath) throws Throwable {
        ...
        //WriteUtil.log("trc20 result:" + result.toJSONString(), filepath);
        ...
        String txid = TronUtils.signAndBroadcast(tronUrl, privateKey, tx, filepath);
        if (txid != null) {
            WriteUtil.log("txid:" + txid, filepath);
            return txid;
        }
        return null;
    }
    ...
    public  static void generateAddress(){
        ...
        sb.append("新的地址：").append("\n");
        sb.append("address:").append(address).append("\n");

        String privateKey = addressMap.get("privateKey");
        String hexAddress = addressMap.get("hexAddress");

        sb.append("hexAddress:").append(hexAddress).append("\n");
        sb.append("privateKey:").append(privateKey).append("\n\n");

        String filePath = "/Users/shijianhua/address/address112.txt";
        System.out.println("sb:" + sb.toString());
        //WriteUtil.log(sb.toString(), filePath, true);
    ...
    public static void main(String[] args) {
        ...
        BlockWalletBean blockWalletBean = BlockWalletBean.getInstance();
        String fromAddress_private_key = blockWalletBean.privateKey;
        String toAddress = "TEKEELcpqhPracwUbupfF5FBDRwxSRN5yH";
